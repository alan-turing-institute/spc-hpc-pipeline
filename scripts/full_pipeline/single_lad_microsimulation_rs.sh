...
hyperfine -M 1 "./target/release/assignment -c config/ass_current_2012.json -r ${var}"

echo 'Running assigment for 2020'
hyperfine -M 1 "./target/release/assignment -c config/ass_current_2020.json -r ${var}"

echo 'Running assigment for 2022'
hyperfine -M 1 "./target/release/assignment -c config/ass_current_2022.json -r ${var}"

echo 'Running assigment for 2032'
hyperfine -M 1 "./target/release/assignment -c config/ass_current_2032.json -r ${var}"

echo 'Running assigment for 2039'
hyperfine -M 1 "./target/release/assignment -c config/ass_current_2039.json -r ${var}"
